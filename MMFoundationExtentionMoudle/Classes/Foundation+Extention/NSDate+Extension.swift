...
public extension Date {
    ...
    /** 当前日期是这一年/月的第几周 默认是这年的第几周*/
    func getWeekly(WithWeaklyType type: MMWeeklyType) -> String {
        ...
        var weakly: Int = components.weekOfYear!
        switch type {
            case .year:
                weakly = components.weekOfYear!
            case .month:
                weakly = components.weekOfMonth!
        }
        return "第\(weakly)周"
    }
